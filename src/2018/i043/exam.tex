...
%-----------------------------------------------------------
%
The final result is also shown in the manual,
%
% Figure
%-----------------------------------------------------------
   \begin{figure}
...
\path[fill=lightgray!40] (4*\x,4*\y) -- (4*\x+4,4*\y-4) -- (4*\x,4*\y-8) -- (4*\x-4,4*\y-4);

\fill (4*\x,4*\y) circle (5pt) node[above left] {$\y$};
\fill (4*\x+4,4*\y-4) circle (5pt) node[below right] {$\x+4$};
\fill (4*\x-4,4*\y-4) circle (5pt) node[below left] {$\x-4$};
\fill (4*\x,4*\y-8) circle (5pt) node[below left] {$\y-8$};

\draw (4*\x,4*\y) -- (4*\x+4,4*\y-4);
\draw (4*\x,4*\y) -- (4*\x-4,4*\y-4);
\draw (4*\x,4*\y-8) -- (4*\x+4,4*\y-4);
\draw (4*\x,4*\y-8) -- (4*\x-4,4*\y-4);
}

\draw[thin,->] (-22,0) -- (22,0) node[right] {$\hat{x}$};
\draw[thin,->] (0,-22) -- (0,22) node[above] {$\hat{y}$};
\end{tikzpicture}
   %
