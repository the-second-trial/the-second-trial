...
\end{proof}
\end{proposition}
Proposition \ref{the:3degpoly} shows that 3-degree polynomials can be used
...
\begin{proposition}[Condition on 3-degree polynomials]
...
\subsection{Analyzing proposals}
\label{sec:c1p2}
...
\begin{proposition}[$a_n$ and $b_n$ satisfy equations \ref{eq:fconds}]
