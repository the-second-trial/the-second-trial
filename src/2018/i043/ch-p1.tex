...
&+ \int^{1}_{0} \mathrm{d} x= 
        ...
        \left[x\right]_0^1 = \frac{\gamma}{4} S \implies \notag\\
&\frac{a}{4} + \frac{b}{3} + 1 = \frac{\gamma}{4} S 
\end{align*}
...
that there exist values for $a$ and $b$, which together to those of $c$ and $d$ we
...
\end{pmatrix}
\end{equation*}
Considering that $3 \gamma S = 3 \cdot \frac{55}{100} \cdot 1 = \frac{33}{20}$,
we have that $a = 8 - \frac{33}{20} = \frac{127}{20}$, and 
$b = -9 + \frac{33}{20} = -\frac{147}{20}$