...
Therefore $g^{\prime\prime}$ is also continuous\sidenote{Fun fact: if you extend
...
are continuous. That is why $g \in \mathcal{C}^\infty$. Such functions are called \smallcaps{infinitely differentiable}.}.
