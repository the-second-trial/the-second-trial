...
\begin{figure*}[h] % Full width figure
    \input{problem_1_L_gplot.diag}%
    \caption{This is the caption and much more to add come in here.}%
    \label{fig:fplot}%
\end{figure*}

\paragraph[Problem 4]{Symmetry of $g$}
\label{par:subp4_1}
\marginnote{\smallcaps{\nameref{par:subp4_1}}}
...
\paragraph[Problem 5]{Tangency between $f$ ad $g$}
\label{par:subp5_1}
\marginnote{\smallcaps{\nameref{par:subp5_1}}}
...
\paragraph[Problem 6]{Area calculation}
\label{par:subp6_1}
\marginnote{\smallcaps{\nameref{par:subp6_1}}}
